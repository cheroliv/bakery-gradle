...
* https://stackoverflow.com/a/3614344/13104550
...
== Répository et code sample

github repository: https://github.com/cheroliv/html-codebase[html-codebase, window = "_blank"]
