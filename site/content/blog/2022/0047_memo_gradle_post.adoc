...
== Pour relancer les taches qui ont échouées, utiliser l'option `--rerun-tasks`
...
.voir aussi :
* https://docs.gradle.org/current/userguide/command_line_interface.html#sec:command_line_warnings[ref]
* https://docs.gradle.org/current/userguide/command_line_interface.html#sec:command_line_options[ref]
* https://stackoverflow.com/a/36178581/837404[discussion]